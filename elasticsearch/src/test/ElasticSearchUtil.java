...
import com.example.elasticsearch.pojo.EsField;
...
public class ElasticSearchUtil {
	...
	public String createType(String index, String type, List<EsField> fieldList) {
	...
	public XContentBuilder getMapping(List<EsField> fieldList) {
	...
	public String insertData(String index, String type, JSONObject data) {
	...
	public String bulkInsertData(String index, String type, JSONArray batchData,
			String idField) {
	...
	public String updateData(String index, String type, String id, JSONObject data) {
	 ...
	 * @param response
	 */
	private void printIndexInfo(IndexResponse response) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> matchQuery(String searchField, String keyword) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> matchMultiQuery(String[] searchFields, String keyword) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> termQuery(String searchField, String keyword) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> fuzzyQuery(String searchField, String keyword) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> wildcardQuery(String searchField, String keyword) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> searchScrollFunction() {
	 ...
	 * @return
	 */
	/*public PageInfo queryForPage(BoolQueryBuilder boolQueryBuilder, int pageno, int pagesize,
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryForListByScroll(BoolQueryBuilder boolQueryBuilder,
			SortBuilder sortBuilder) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> queryForList(BoolQueryBuilder boolQueryBuilder,
			SortBuilder sortBuilder) {
	 ...
	 * @return
	 */
	private List<Map<String, Object>> searchFunction(BoolQueryBuilder boolQueryBuilder,
